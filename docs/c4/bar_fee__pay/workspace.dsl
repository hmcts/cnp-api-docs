...
workspace {
    ...
    views {
        ...
        systemContext bar_fee__pay "bar_fee__pay-context" {
            include *
            # exclude caseworker
            # exclude citizen
            # include xui
        ...
        container bar_fee__pay "bar_fee__pay-overview" {
            include *
            # exclude caseworker
            # exclude citizen
            # include xui
        ...
        # container bar_fee__pay "bar_fee__pay-citizen" {
        #     include *
        #     exclude idam
        #     exclude rpe
        #     exclude bsp
        ...
        # container bar_fee__pay "bar_fee__pay-caseworker" {
        #     include *
        #     include caseworker
        #     include xui
        #     exclude citizen
