workspace {
    model {
        ...
        citizen -> probate_caveats_frontend "Uses"
    ...
    views {
        ...
        systemContext probate "probate-context" {
            include *
            exclude caseworker
            exclude citizen
            include xui
        ...
        container probate "probate-overview" {
            include *
            exclude caseworker
            exclude citizen
            include xui
        ...
        container probate "probate-citizen" {
            include *
            exclude idam
            exclude rpe
            exclude bsp
        ...
        container probate "probate-caseworker" {
            include *
            include caseworker
            include xui
            exclude citizen
            exclude probate_frontend
            exclude idam
            exclude rpe
            exclude relationship==bsp->*
