...
workspace {
    ...
    views {
        ...
        systemContext hmi_gateway "hmi_gateway-context" {
            include *
            # exclude caseworker
            # exclude citizen
            # include xui
        ...
        container hmi_gateway "hmi_gateway-overview" {
            include *
            # exclude caseworker
            # exclude citizen
            # include xui
        ...
        # container hmi_gateway "hmi_gateway-citizen" {
        #     include *
        #     exclude idam
        #     exclude rpe
        #     exclude bsp
        ...
        # container hmi_gateway "hmi_gateway-caseworker" {
        #     include *
        #     include caseworker
        #     include xui
        #     exclude citizen
